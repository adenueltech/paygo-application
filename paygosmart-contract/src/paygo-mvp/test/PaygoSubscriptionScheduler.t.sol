...
contract PaygoSubscriptionSchedulerTest is Test {
    ...
    function setUp() public {
        ...
        scheduler = new PaygoSubscriptionScheduler(
    ...
    function testRunBillingCycle() public {
        ...
        scheduler.runBillingCycle(subId);

        assertEq(vault.getUserBalance(user, address(0)), 4 ether);
