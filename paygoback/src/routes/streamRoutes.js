...
const { startSession, addMetrics, stopSession, getUserSessions, generateAgoraToken } = require('../controllers/StreamingController');
...
router.get('/:sessionId/agora-token', auth, generateAgoraToken);
